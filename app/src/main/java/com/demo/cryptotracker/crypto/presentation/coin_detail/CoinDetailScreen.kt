package com.demo.cryptotracker.crypto.presentation.coin_detail
...
import com.demo.cryptotracker.crypto.presentation.coin_detail.component.InfoCard
import com.demo.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.demo.cryptotracker.crypto.presentation.coin_list.previewCoin
import com.demo.cryptotracker.crypto.presentation.models.toDisplayableNumber
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    ...
                    formattedText = absoluteChangeFormatted?.formatted.toString(),
                    icon = if (isPositive) {
